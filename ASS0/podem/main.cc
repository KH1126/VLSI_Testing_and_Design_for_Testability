...
int main(int argc, char ** argv)
{
    ...
    {
        unsigned fanout_1=Circuit.signal(),stemNO=Circuit.stemNumber(),branch_No=Circuit.branchNumber();
        cout<<"Number of inputs: " <<Circuit.No_PI()<<endl;
        cout<<"Number of outputs: "<<Circuit.No_PO()<<endl;
        cout<<"Total number of gates including inverter, or, nor, and, nand: "<<Circuit.getMerge()<<endl;
        cout<<"Total number of gates inverter: "<<Circuit.getNOT()<<endl;
        cout<<"Total number of gates or: "<<Circuit.getOR()<<endl;
        cout<<"Total number of gates nor: "<<Circuit.getNOR()<<endl;
        cout<<"Total number of gates and: "<<Circuit.getAND()<<endl;
        cout<<"Total number of gates nand: "<<Circuit.getNAND()<<endl;
        cout<<"Total number of Number of flip-flops: "<<Circuit.getDFF()<<endl;
        cout<<"Total number of signal nets: "<<(fanout_1+stemNO+branch_No)<<endl;
        cout<<"Number of branch nets: "<<branch_No<<endl;
        cout<<"Number of stem nets: "<<stemNO<<endl;
        // cout<<"Average number of fanouts of each gate (all types): "<<endl;
        // cout<<"\t"<<"Average fanouts of not gate: "<<(float)Circuit.getnotf()/Circuit.getNOT()<<endl;
        // cout<<"\t"<<"Average fanouts of and gate: "<<(float)Circuit.getandf()/Circuit.getAND()<<endl;
        // cout<<"\t"<<"Average fanouts of nand gate: "<<(float)Circuit.getnandf()/Circuit.getNAND()<<endl;
        // cout<<"\t"<<"Average fanouts of or gate: "<<(float)Circuit.getorf()/Circuit.getOR()<<endl;
        // cout<<"\t"<<"Average fanouts of nor gate: "<<(float)Circuit.getnorf()/Circuit.getNOR()<<endl;
        cout<<"Average number of fanouts of all gate (including inverter, or, nor, and, nand): "<<(float)(Circuit.getnotf()+Circuit.getandf()+Circuit.getnandf()+Circuit.getorf()+Circuit.getnorf())/Circuit.getMerge()<<endl;
    }
    else {
